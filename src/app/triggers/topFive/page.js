...
export default function TopFiveTriggersPage() {
  ...
  return (
    <div className="analysisContainer">
      ...
      {TopFiveTriggers ? TopFiveTriggers.map((trigger) => <TopTriggersCard key={trigger.id} triggerObj={trigger} />) : <h2>Looks like you haven&apos;t logged enough symptoms to run an analysis. Keep logging symptoms and check back in a few days!</h2>}
    </div>
  );
}
